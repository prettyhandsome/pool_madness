...
RSpec.describe Queries::BracketType do
  ...
  context "fields" do
    let(:fields) { %w(id model_id name owner pool editable picks tie_breaker status points possible_points best_possible_finish eliminated final_four game_decisions game_mask) }
