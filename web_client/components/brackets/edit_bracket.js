...
class Bracket extends Component {
  ...
  handleSlotClick = (slotId, choice) => {
    ...
    let chars = bracket.game_decisions.split('')
    chars[slotId] = choice - 1
    bracket.game_decisions = chars.join('')
  ...
  render() {
    ...
    return <div className="bracket-edit">
      <h2>{this.title()}</h2>
      <Tournament tournament={tournament} bracket={bracket} slotClickHandler={this.handleSlotClick}/>
    </div>
  }
}
