...
class Tournament extends Component {
  render() {
    const { tournament, bracket, slotClickHandler, editing } = this.props
    ...
    return <div className='bracket'>
      ...
      <div className={`bracket-body ${fieldClass}`}>
        {rounds.map(r => <Round key={r.number} round={r} tournament={tournament} bracket={bracket} slotClickHandler={slotClickHandler}/>)}
